        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <label class="block text-gray-700 text-xs font-bold mb-2">Ganti Logo (Kosongkan jika tidak ingin diubah)</label>
                    <input type="file" name="logo" class="w-full text-sm mt-1 block">
                </div>
