...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        ...
        <a href="{{ route('auth.google') }}"
           class="w-full flex items-center justify-center gap-3 py-4 bg-white border-2 border-slate-200 rounded-2xl font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition mb-6 shadow-sm">
        ...
        <div class="relative mb-6">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="px-4 bg-white text-slate-400 font-medium">atau login manual</span>
            </div>
        </div>
        ...
        <div class="mt-6 text-center text-sm">
            <span class="text-slate-500">Ingin mendaftarkan HIMA/Kepanitiaan?</span>
            <a href="{{ route('organizer.register') }}" class="text-indigo-600 font-bold hover:underline ml-1">Daftar disini</a>
        </div>
    </div>
</body>
</html>
