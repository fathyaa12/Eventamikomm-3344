...
<body class="bg-slate-50 text-slate-900">
    ...
    <nav
        ...
        <div class="hidden md:flex gap-8 font-medium items-center">
            ...
            <a href="{{ route('organizer.register') }}" class="text-indigo-600 hover:text-indigo-800 font-bold transition">Daftar Kepanitiaan</a>
            ...
            @else
                <a href="{{ route('auth.google') }}"
                   class="ml-4 pl-4 border-l border-slate-200 flex items-center gap-2 text-sm font-bold text-slate-600 hover:text-indigo-600 transition">
    ...
    <footer class="bg-indigo-900 text-indigo-100 py-20 px-6 mt-20">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="#" class="hover:text-white transition">Welcome</a></li>
