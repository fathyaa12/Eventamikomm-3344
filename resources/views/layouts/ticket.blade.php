...
<head>
    ...
    <style>
        ...
        /* Menghilangkan header & footer otomatis dari browser saat print dokumen */
        @media print {
            @page {
                margin: 0;
            }
...
<body class="bg-indigo-600 print:bg-white text-white min-h-screen flex items-center justify-center p-6">
    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white text-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl relative z-10">
            <div class="p-8 bg-indigo-50 border-b-4 border-dashed border-indigo-100 text-center relative">
                ...
                <div class="absolute -left-4 -bottom-4 w-8 h-8 bg-indigo-600 print:bg-white rounded-full z-20"></div>
                <div class="absolute -right-4 -bottom-4 w-8 h-8 bg-indigo-600 print:bg-white rounded-full z-20"></div>
            </div>
            ...
            <div class="px-8 pb-8 relative z-30">
                <button type="button" onclick="window.print()"
                    class="w-full py-4 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg hover:bg-indigo-700 active:scale-95 transition-all block text-center cursor-pointer">
                    Cetak / Simpan PDF
                </button>
                <a href="{{ url('/') }}"
                    class="block text-center mt-4 text-slate-500 font-bold hover:text-indigo-600 transition-colors py-2">
                    Kembali ke Beranda
                </a>
            </div>
        </div>
