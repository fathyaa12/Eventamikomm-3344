            ...
            <div class="flex flex-col gap-4">
                ...
                @guest
                    <a href="{{ route('auth.google') }}"
                       class="w-max flex items-center justify-center gap-3 px-8 py-4 bg-white border-2 border-slate-200 rounded-2xl font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition shadow-sm mt-2">
